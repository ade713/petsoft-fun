...
const userData: Prisma.UserCreateInput = {
  ...
  pets: {
    create: [
      ...
      {
        name: "Portia",
        ownerName: "Fred Oregon",
        imageUrl:
          "https://images.unsplash.com/photo-1585908286456-991b5d0e53f4?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        age: 6,
        notes: "Allergic to chicken.",
      },
    ],
